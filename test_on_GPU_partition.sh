...
#SBATCH --ntasks=2  # Number of Tasks (up-to 32 jobs running at the same time)
...
CONFIG_FILE1="/mainfs/home/fb1n15/MARL-ReverseAuction/marl-edge-cloud/configs/config_first-price.yaml"
...
python ./src/marl.py train --config $CONFIG_FILE1
