...
#     opm.optimal_pricing(df_tasks, df_nodes, n_time, n_tasks_in_total, n_nodes,
...
# # print the total value of tasks
# total_value = 0
# for i in range(n_tasks_in_total):
#     total_value += (df_tasks.loc[i, "valuation_coefficient"] *
#                     df_tasks.loc[i, "usage_time"])
# print(f"total value of tasks = {total_value}")
# display_allocation(allocation_scheme, n_nodes, n_tasks_in_total, df_tasks, n_time)
