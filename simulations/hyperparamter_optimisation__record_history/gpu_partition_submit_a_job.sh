...
#SBATCH --gres=gpu:2  # use 2 GPUs for each task
...
n_tasks=1
CONFIG_FILE="/mainfs/home/fb1n15/MARL-ReverseAuction/marl-edge-cloud/simulations/hyperparamter_optimisation__record_history/config_HPO_iridis5.yaml"
