...
# Scaling up experiment
  1)
    CONFIG_FILE="configs/experiments/hyperparameters/cpu_ppo_fc_independent_with_history.yaml"
    ;;
  2)
    CONFIG_FILE="configs/experiments/hyperparameters/cpu_ppo_fc_independent_without_history.yaml"
    ;;
esac
